...
<script>
    let netIncome = {
        init:()=>{
            $('#analyticalProcedure').click(()=>{
                console.log('clicked');
                window.location.href='/sales/netIncome/analyticalprocedure';
            })
        }
    };
    $(()=>{
...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <a href="/sales/gpt" class="get-started-btn scrollto">Get Started</a>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                    ...
                    <ul>
                        <li><i class="ri-check-double-line"></i> 2022년 감사의견보고서 </li>
                        <li><i class="ri-check-double-line"></i> 2022년 재무상태표 </li>
                        <li><i class="ri-check-double-line"></i> 2022년 Income Statement </li>
                        <li><i class="ri-check-double-line"></i> 2022년 현금흐름표 </li>
                    </ul>
                    <p>
                        <button class="btn btn-warning" id="analyticalProcedure"> Analytical Procedure </button>
                    </p>
                </div>
            </div>
